...
class MenuFrameHvH(ctk.CTkFrame):
    def __init__(self, master):
        ...
        # print(f"gameboard_players_turn: {self.master.game_board.players_turn.get()}")
        # print()
        ...
        self.player_selection_frame.grid_rowconfigure((0, 1), weight=1)

        # Player Selection Radio Buttons Frame
        self.player_selection_radio_frame = ctk.CTkFrame(self.player_selection_frame)
        self.player_selection_radio_frame.grid(row=1, column=0, sticky="nsew")
    ...
    def new_game(self):
        print("%" * 50)
        print("--- Starting a New Human vs Human Game ---")
        print("%" * 50)
        print()
        ...
        self.master.game_board_hvh.reset_board()
    ...
    def player_selected(self):
        ...
        self.select_your_player_label.configure(
            text=f"Player {self.player_selection.get()} Selected",
            text_color="gray70",
        )
        self.master.game_board_hvh.enable_board(self.player_selection.get())
    ...
    def winner(self, player):
        ...
        self.master.game_board_hvh.disable_board()
